...
}function s(s,a,c,u){if(!o(a)&&!r(a))throw new Error("BAD PARAM: must search into an object or an array");var f,l=0,d=function(o,r){return e(o)&&n(r)?o.match(r):t(o,r)},h={key:function(t,e,n){
...
return t[e]},a)},container:i.slice(0,f-1).join("/"),parentContainer:i.slice(0,f-2).join("/"),regexp:s,level:r}),l++),g(o[e],n,i,r+1)},g=function(t,e,n,o){if(!i(t)){var r,s
...
CONFIG:{},ns:{},dom:{},events:{},cookie:{},history:{},i18n:{},io:{},utils:{}};!function(t){t.type={},t.type.isFunction=function(t){return typeof t===Hok.TYPES.F},t.type.isDefined=function(t){
return typeof t!==Hok.TYPES.U},t.type.isObject=function(e){var n=String(e)!==e,o=e===Object(e),r=t.type.isFunction(e),i={}.toString.call(e).match(/\[object\sObject\]/);return n&&o&&r&&!(!i||!i.length)
},t.type.isArray=function(t){if(Array.isArray&&Array.isArray(t))return!0;var e=String(t)!==t,n={}.toString.call(t).match(/\[object\sArray\]/);return e&&!(!n||!n.length)}}(Hok.utils),
Hok.ns.check=function(t,e){t=t.replace(/^\//,"");var n=t.split(/\.|\//),o=n.length,r=0;if(e=typeof e!==Hok._U_?e:Hok.W,!t)return e;for(null;r<o;r+=1){if(typeof e[n[r]]===Hok._U_)return;e=e[n[r]]}
return e},Hok.CONFIG={AUTHOR:"Federico Ghedina",LANG:"en",ENGY:{STATS:!1,MODES:["PRE","LIVE"],MODE:0,COMPONENTS:{EXT:".js",URL:"/components/",NAME_PREPEND:"",PATH_SEPARATOR:"/"}},NS:"hokuto",
NAME:"hokuto",VERSION:"0.1.0"},Hok.cookie={enabled:!0,cookie_nocookiesaround:!1,initCheck:function(){return Hok.W.navigator.cookieEnabled},set:function(t,e,n,o,r,i){if(!Hok.cookie.enabled)return!1
...
t.filterHtml=function(t){return""+t},t.setText=function(t,e){t.appendChild(document.createTextNode(e))},t.setHtml=function(e,n){e.innerHTML=t.filterHtml(n)}}(Hok.dom),function(t){var e={}
;!function(t,e){var n=function(){},o=function(t,e){var n=Object.assign({},t);for(var o in e)e.hasOwnProperty(o)&&(n[o]=e[o]);return n},r=function(t){
var r=t.url,i=t.timeout||0,s=t.user||null,a=t.password||null,c=t.responseType,u=t.contentType,f=t.body||null,l=t.method,d=t.onCompleted||n,h=t.onLoad||n,p=t.onError||n,m=t.onAbort||n,g=t.onProgress||n,v=t.onLoadend||n,k=t.onLoadstart||n,y=t.onTimeout||n,H=t.headers||{},E=!!t.withCredentials,b=new XMLHttpRequest,T=!1
;if(b){b.responseType=c,b.withCredentials=E,b.timeout=i||null,b.addEventListener("load",h),b.addEventListener("progress",g),b.addEventListener("error",p),b.addEventListener("timeout",y),
...
var t=b.status;(0===t||t>=200&&t<400)&&(!T&&d(b),T=!0)}},"application/xml"===u&&b.overrideMimeType("text/xml"),f&&(H=o(H,{"X-Requested-With":"XMLHttpRequest"}),
e.FormData&&f instanceof e.FormData||(H=o(H,{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"})),f=new URLSearchParams(f)),b.open(l,r,!0,s,a);for(var N in H)b.setRequestHeader(N,H[N])
...
t.rendered=!0),t})}).then(function(){return t.parentKnot&&t.parentKnot.solve(),t}).catch(function(){t.frag.removeChild(t.node)}))},Knot.prototype.clear=function(){this.ender&&this.ender(),
this.target.removeChild(this.node),this.unhandleEvents()},Knot.prototype.solve=function(){this.debt>0&&this.debt--,this.debt<=0&&(this.solved=!0,this.render())},Knot.prototype.report=function(){
