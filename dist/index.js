...
if(!Hok.utils.type.isDefined(t)||!Hok.utils.type.isDefined(t.config))throw"Nothing to render";var e=t.config,n=!!t.clear,o=t.name,r=document.currentScript&&document.currentScript.parentNode
;return Hok.solve(e).then(function(t){return"target"in t||!r||(t.target=r),t.endFunctions=[],t.nodes=__nodes,new Knot(t,n).render().then(function(t){return o&&(__renders[o]=t),t})})}function get(t){
...
}function s(s,c,a,u){if(!o(c)&&!r(c))throw new Error("BAD PARAM: must search into an object or an array");var l,f=0,d=function(o,r){return e(o)&&n(r)?o.match(r):t(o,r)},h={key:function(t,e,n){
...
var i=[].concat.call(t,[e]),s=h(e,o[e],n),a=u.min<=r&&r<=u.max,l=i.length;a&&s&&(p.push({obj:o,value:o[e],key:i[l-1],parentKey:i[l-2],path:i.join("/"),getter:function(){return i.reduce(function(t,e){
return t[e]},c)},container:i.slice(0,l-1).join("/"),parentContainer:i.slice(0,l-2).join("/"),regexp:s,level:r}),f++),g(o[e],n,i,r+1)},g=function(t,e,n,o){if(!i(t)){var r,s
;if(t instanceof Array)for(r=0,s=t.length;r<s&&(m(n,r,e,t,o),u.limit!==f);r++);else if("object"==typeof t)for(r in t)if(m(n,r,e,t,o),u.limit===f)break}};return u.limit="limit"in u?~~u.limit:1/0,
u.min="min"in u?~~u.min:0,u.max="max"in u?~~u.max:1/0,0===u.limit?p:(u.min=u.min<0?0:u.min,u.max<u.min&&(l=u.min,u.min=u.max,u.max=l),g(c,a,[],0),u.sorter?p.sort(u.sorter):p)}return{
...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=searchHash);var Channeljs=function(){var t={},e=function(t,e){return t.indexOf(e)},n=function(){this.topic2cbs={},
this.lateTopics={},this.enabled=!0},o=function(t,e){var n=t.enabled;return t.enabled=e,n!==t.enabled},r=n.prototype;return r.enable=function(){return o(this,!0)},r.disable=function(){return o(this,!1)
},r.pub=function(t,e){var n,o=0,r=[];if(e instanceof Array||(e=[e]),!(t in this.topic2cbs&&this.enabled))return t in this.lateTopics?this.lateTopics[t].push({args:e}):this.lateTopics[t]=[{args:e}],
null;if("*"in this.topic2cbs)for(o=0,n=this.topic2cbs["*"].length;o<n;o+=1)r.push(this.topic2cbs["*"][o].apply(null,e));for(o=0,
...
get:function(e){return e in t||(t[e]=new n),t[e]}}}();"object"==typeof exports&&(module.exports=Channeljs);var Hok={W:_,_U_:"undefined",WD:_.document,H:_.history,TYPES:{U:"undefined",F:"function"},
noop:function(){},CONFIG:{},ns:{},dom:{},events:{},cookie:{},history:{},i18n:{},io:{},utils:{},ps:Channeljs};!function(t){t.type={},t.type.isFunction=function(t){return typeof t===Hok.TYPES.F},
t.type.isDefined=function(t){return typeof t!==Hok.TYPES.U},t.type.isObject=function(e){var n=String(e)!==e,o=e===Object(e),r=t.type.isFunction(e),i={}.toString.call(e).match(/\[object\sObject\]/)
;return n&&o&&r&&!(!i||!i.length)},t.type.isArray=function(t){if(Array.isArray&&Array.isArray(t))return!0;var e=String(t)!==t,n={}.toString.call(t).match(/\[object\sArray\]/)
;return e&&!(!n||!n.length)}}(Hok.utils),Hok.ns.check=function(t,e){t=t.replace(/^\//,"");var n=t.split(/\.|\//),o=n.length,r=0;if(e=typeof e!==Hok._U_?e:Hok.W,!t)return e;for(null;r<o;r+=1){
if(typeof e[n[r]]===Hok._U_)return;e=e[n[r]]}return e},Hok.CONFIG={AUTHOR:"Federico Ghedina",LANG:"en",ENGY:{STATS:!1,MODES:["PRE","LIVE"],MODE:0,COMPONENTS:{EXT:".js",URL:"/components/",
NAME_PREPEND:"",PATH_SEPARATOR:"/"}},NS:"hokuto",NAME:"hokuto",VERSION:"0.1.0"},Hok.cookie={enabled:!0,cookie_nocookiesaround:!1,initCheck:function(){return Hok.W.navigator.cookieEnabled},
set:function(t,e,n,o,r,i){if(!Hok.cookie.enabled)return!1;Hok.cookie.cookie_nocookiesaround=!1;var s=new Date,c=new Date(s.getTime()+n)
;return Hok.WD.cookie=[t,"=",Hok.W.escape(e),n?";expires="+c.toGMTString():"",o?";path="+o:"",r?";domain="+r:"",i?";secure":""].join(" "),!0},del:function(t,e,n){if(!Hok.cookie.enabled)return!1
...
t.noAttrs=["innerHTML","style","dataset","className"],t.setStyle=function(t,e){for(var n in e)"float"===n?t.style[n.replace(/^float$/i,"cssFloat")]=e[n]:t.style[n]=e[n]},t.setAttrs=function(e,n){
if(typeof n===Hok.TYPES.U)throw new Error("ERR: attrs needed");for(var o in n)t.noAttrs.indexOf(o)<0&&e.setAttribute(o,n[o])},t.unsetAttrs=function(e,n){
if(typeof n===Hok.TYPES.U)throw new Error("ERR: attrs needed");for(var o in n)t.noAttrs.indexOf(o)<0&&e.removeAttribute(o,n[o])},t.setData=function(t,e){
if(typeof e===Hok.TYPES.U)throw new Error("ERR: data needed");for(var n in e)t.dataset[n]=e[n]},t.setClass=function(t,e){e.split(",").forEach(function(e){t.classList.add(e)})},
t.unsetData=function(t,e){if(typeof e===Hok.TYPES.U)throw new Error("ERR: data needed");for(var n in e)delete t.dataset[n]},t.remove=function(t){return t.parentNode&&t.parentNode.removeChild(t)},
t.filterHtml=function(t){return""+t},t.setText=function(t,e){t.appendChild(document.createTextNode(e))},t.setHtml=function(e,n){e.innerHTML=t.filterHtml(n)},t.script=function(e){
var n=document.createElement("script"),o=e&&e.attrs;return o&&t.setAttrs(n,o),e.content?n.innerHTML=e.content:e.src&&n.setAttribute("src",e.src),n},t.style=function(e){var n=e.content?{tag:"style",
attrs:{}}:{tag:"link",attrs:{rel:"stylesheet",href:e.href}},o=document.createElement(n.tag),r=Object.assign(n.attrs,e&&e.attrs||{});return t.setAttrs(o,r),e.content&&(o.innerHTML=e.content),o},
t.head=document.getElementsByTagName("head")[0]}(Hok.dom),function(t){var e={};!function(t,e){var n=function(){},o=function(t,e){var n=Object.assign({},t)
;for(var o in e)e.hasOwnProperty(o)&&(n[o]=e[o]);return n},r=function(t){
var r=t.url,i=t.timeout||0,s=t.user||null,c=t.password||null,a=t.responseType,u=t.contentType,l=t.body||null,f=t.method,d=t.onCompleted||n,h=t.onLoad||n,p=t.onError||n,m=t.onAbort||n,g=t.onProgress||n,v=t.onLoadend||n,y=t.onLoadstart||n,k=t.onTimeout||n,b=t.headers||{},H=!!t.withCredentials,E=new XMLHttpRequest,T=!1
;E.responseType=a,E.withCredentials=H,E.timeout=i||null,E.addEventListener("load",h),E.addEventListener("progress",g),E.addEventListener("error",p),E.addEventListener("timeout",k),
E.addEventListener("abort",m),E.addEventListener("loadend",function(){v(E)}),E.addEventListener("loadstart",function(){y(E)}),E.onreadystatechange=function(){if(E.readyState===XMLHttpRequest.DONE){
var t=E.status;(0===t||t>=200&&t<400)&&(!T&&d(E),T=!0)}},"application/xml"===u&&E.overrideMimeType("text/xml"),l&&(b=o(b,{"X-Requested-With":"XMLHttpRequest"}),
e.FormData&&l instanceof e.FormData||(b=o(b,{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"})),l=new URLSearchParams(l)),E.open(f,r,!0,s,c);for(var N in b)E.setRequestHeader(N,b[N])
;return E.send(l),E};t.getJson=function(t){return r(o(t,{method:"GET",responseType:"json",contentType:"application/json"}))},t.getXML=function(t){return r(o(t,{method:"GET",responseType:"document",
...
t.load=function(t){e=t},t.parse=function(t){var e,o,r,i=searchHash.forValue(t,n),s=i.length,c=0;for(null;c<s;c++)r=i[c],
...
;return this.rendered?(this.initRerender(),Promise.resolve(this)):(this.frag.appendChild(this.node),this.debt?this.children.reduce(function(e,n){var o=Object.assign({rendered:t.rendered},n,{
target:t.node,parentKnot:t,rootKnot:t.rootKnot}),r=new Knot(o);return t.childrenKnots.push(r),e.then(function(){return r.render()})},Promise.resolve()).then(function(){return t
...
;var e=((t.duration||500)/1e3).toFixed(1),n=t.additionalStyles||"",o=hokuto.dom.style({content:"body{transition:opacity "+e+"s ease-in-out; opacity: 1;}"+n});document.body.appendChild(o)}return{
fadeIn:t}}();var __renders={},__nodes={};return{io:Hok.io,i18n:Hok.i18n,dom:Hok.dom,events:Hok.events,utils:Hok.utils,cookie:Hok.cookie,fx:Hok.fx,ps:Hok.ps,render:render,get:get,
getKnotById:function(t){return t in __nodes?__nodes[t]:null},getElement:function(t){return t in __renders&&__renders[t]},getElements:function(){return __renders}}}(window)
