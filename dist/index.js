...
*/
var hokuto=function(_){"use strict";function Knot(e,t){this.config=e,this.clearTarget=t,this.rendered=!1,this.frag=document.createDocumentFragment(),this.target=this.config.target||document.body,
this.children=this.config.children||[],this.debt=~~this.children.length,this.solved=0===this.debt,this.cb=this.config.cb||resolutive,this.parentKnot=this.config.parentKnot||null,
this.rootKnot=this.config.rootKnot||this,this.initCheck=this.config.initCheck||resolutive,this.abort=this.config.abort||resolutive,this.aborted=!1,this.ender=!1,this.state="state"in e?e.state:{},
this.nodes=e.nodes||this.rootKnot.nodes,this.rootNodeUnhandlersCollector=[],this.unhandlers={},this.abort.call(this).then().catch(function(){self.rootKnot.aborted=!0}),this.initTag(),
this.prepareState(),this.initialize()}function render(e,t,n){return Hok.solve(e).then(function(e,o){return e.endFunctions=[],e.saveKnotRef=function(e,t){__nodes[e]=t},e.nodes=__nodes,
new Knot(e,t).render().then(function(e){return n&&(__renders[n]=e),e}).catch(function(e){console.log({r:e})})}).catch(function(e){console.log({r:e})})}function get(e){
var t=document.createElement("div");return e.target=t,render(e)}var searchHash=function(){function e(e,t){return JSON.stringify(e)===JSON.stringify(t)&&!n(t)}function t(e){
return"string"==typeof e||e instanceof String}function n(e){return e instanceof RegExp}function o(e){
...
}function s(s,a,c,f){if(!o(a)&&!r(a))throw new Error("BAD PARAM: must search into an object or an array");var u,l=0,d=function(o,r){return t(o)&&n(r)?o.match(r):e(o,r)},h={key:function(e,t,n){
...
var i=[].concat.call(e,[t]),s=h(t,o[t],n),c=f.min<=r&&r<=f.max,u=i.length;c&&s&&(p.push({obj:o,value:o[t],key:i[u-1],parentKey:i[u-2],path:i.join("/"),getter:function(){return i.reduce(function(e,t){
return e[t]},a)},container:i.slice(0,u-1).join("/"),parentContainer:i.slice(0,u-2).join("/"),regexp:s,level:r}),l++),k(o[t],n,i,r+1)},k=function(e,t,n,o){if(!i(e)){var r,s
...
f.min="min"in f?~~f.min:0,f.max="max"in f?~~f.max:1/0,0===f.limit?p:(f.min=f.min<0?0:f.min,f.max<f.min&&(u=f.min,f.min=f.max,f.max=u),k(a,c,[],0),f.sorter?p.sort(f.sorter):p)}return{
...
initCheck:function(){return Hok.W.navigator.cookieEnabled},set:function(e,t,n,o,r,i){if(!Hok.cookie.enabled)return!1;Hok.cookie.cookie_nocookiesaround=!1;var s=new Date,a=new Date(s.getTime()+n)
;return Hok.WD.cookie=[e,"=",Hok.W.escape(t),n?";expires="+a.toGMTString():"",o?";path="+o:"",r?";domain="+r:"",i?";secure":""].join(),!0},del:function(e,t,n){if(!Hok.cookie.enabled)return!1;var o=!1
...
;var t=e.currentTarget||typeof e.target!==Hok.TYPES.U?e.target:e.srcElement;if(!t)return!1;for(;3===t.nodeType&&null!==t.parentNode;)t=t.parentNode;return t},Hok.events.ready=function(){
var e,t,n=setInterval(function(){if("complete"===document.readyState)for(clearInterval(n),e=0,t=o.length;e<t;e++)o[e].call(this)},10),o=[];return function(e){
"complete"===document.readyState?e.call(this):o.push(e)}}(),Hok.history=function(){var e=[],t=function(t,n,o){return document.title=o,e.forEach(function(e){e(t,n,o)})};return{push:function(e,n,o){
Hok.H.pushState(n||{},o||"",e),t(e,n,o)},registerHandler:function(t){return e.push(t)},replace:function(e,n,o){Hok.H.replaceState(n||{},o||"",e),t(e,n,o)},back:function(){Hok.H.back()},
resetHandlers:function(){e=[]},state:function(){return Hok.H.state}}}(),Hok.i18n=function(){var e={},t=/i18n\(([^}|]*)?\|?([^}]*)\)/;return{lang:Hok.CONFIG.LANG,switchLang:function(e){Hok.i18n.lang=e
},check:function(e){return e.match(t)},dynamicLoad:function(t,n){var o=Hok.i18n.lang;for(n in t)o in t[n]&&(e[n]=t[n][o])},get:function(t,n){return Hok.ns.check(t,e)||n||"no Value"},load:function(t){
e=t},parse:function(e){var n,o,r,i=searchHash.forValue(e,t),s=i.length,a=0;for(null;a<s;a++)r=i[a],(typeof r.regexp).match(/boolean/i)||(n=Hok.i18n.check(r.regexp[0]))&&(o=Hok.ns.check(r.container,e),
o[r.key]=r.value.replace(n[0],Hok.i18n.get(n[1],n[2])))}}}(),Hok.solve=function(){function Processor(e){this.content=e,this.stats={};var t=e.engy;this.config={
fileNameSeparator:t&&t.fileNameSeparator?t.fileNameSeparator:Hok.CONFIG.ENGY.COMPONENTS.PATH_SEPARATOR,fileNamePrepend:t&&t.fileNamePrepend?t.fileNamePrepend:Hok.CONFIG.ENGY.COMPONENTS.NAME_PREPEND,
ext:t&&t.ext?t.ext:Hok.CONFIG.ENGY.COMPONENTS.EXT,componentsUrl:t&&t.componentsUrl?t.componentsUrl:Hok.CONFIG.ENGY.COMPONENTS.URL}}var _clone=function(e){if(null==e||"object"!=typeof e)return e
;var t,n=e.constructor();for(t in e)e.hasOwnProperty(t)&&(n[t]=_clone(e[t]));return n},_overwrite=function(e,t,n){for(var o=t.split(/\.|\//),r=o.length,i=0;i<r-1;)e=e[o[i++]];e[o[r-1]]=n
},_mergeComponent=function(e,t,n){var o,r=Hok.ns.check(t,e),i=Object.assign({},n);for(o in r)!o.match(/component|params/)&&(i[o]=r[o]);n.protected?_overwrite(e,t,n):_overwrite(e,t,i)
...
delete self.content.component,delete self.content.params),langFunc&&langFunc(self.content),resolve(self.content,computeStats&&self.stats)},xhrStart=+new Date,
preLoaded?cback(preloadedComponents[componentName]):cached?cback(components[componentName]):Hok.io.get(componentName,cback,function(e){cback(cmp404(componentName))})):(end=+new Date,
self.stats.time=end-start,self.stats.elements=elementsN,self.stats.requested=requested,self.stats.xhrTot=xhrTot,resolve(self.content,{}))}()})},function(e){return new Processor(e).parse()}}()
;var resolutive=function(){return Promise.resolve()};Knot.prototype.prepareState=function(){const e="state"in this.config,t=e?this.config.state:{};this.state=typeof t===Hok.TYPES.F?t.call(this):t},
Knot.prototype.setState=function(e){for(var t in e)e.hasOwnProperty(t)&&(this.state[t]=e[t])},Knot.prototype.setCall=function(e){var t=this;e.split(/,/).forEach(function(e){t["set"+e]()})},
Knot.prototype.lateKid=function(e){e in this.nodes?consolw.warn('node already present by "'+Knot.byIdIdentifier+'"'):this.nodes[e]=this},Knot.prototype.initialize=function(){this.rendered=!1,
this.setCall("Ref,Events,Html,Text,Style,Attrs,Data,Classname,End,ById"),
typeof this.config[Knot.identifier]!==Hok.TYPES.U&&typeof this.config.map.elements[this.config[Knot.identifier]]===Hok.TYPES.U&&this.map.add(this.config[Knot.identifier],this)},
Knot.prototype.setById=function(){if(Knot.byIdIdentifier in this.config){var e=this.config[Knot.byIdIdentifier];this.nodes[e]=this}},Knot.prototype.getById=function(e){
return e in this.nodes?this.nodes[e]:null},Knot.prototype.setRef=function(e,t){e?(t||this).map[e]=t||this:typeof this.config.ref!==Hok.TYPES.U&&this.map.add(this.config.ref,this)},
Knot.prototype.setClassname=function(){this.config.className&&Hok.dom.setClass(this.node,this.config.className)},Knot.prototype.setStyle=function(e){
e&&(this.config.style=Object.assign({},this.config.style,e)),this.config.style&&Hok.dom.setStyle(this.node,this.config.style)},Knot.prototype.setAttrs=function(e){
var t="function"==typeof this.config.attrs?this.config.attrs.call(this):this.config.attrs;e&&(t=Object.assign({},t,e)),this.config.attrs&&Hok.dom.setAttrs(this.node,t)},
Knot.prototype.setData=function(e){e&&(this.config.data=Object.assign({},this.config.data,e)),this.config.data&&(this.data=this.config.data,Hok.dom.setData(this.node,this.data))},
Knot.prototype.setText=function(e){typeof e!==Hok.TYPES.U&&(this.config.text=e),typeof this.config.text!==Hok.TYPES.U&&Hok.dom.setText(this.node,this.config.text)},Knot.prototype.setHtml=function(e){
typeof e!==Hok.TYPES.U&&(this.config.html=e),typeof this.config.html!==Hok.TYPES.U&&Hok.dom.setHtml(this.node,this.config.html)},Knot.prototype.setMethods=function(){
var e,t=this,n=Object.keys(this.config);n.forEach(function(n){
(e=n.match(/^method_(\w*)$/i))&&(e[1]in t?console.warn("[WARNING] : method '"+e[0]+"' cant be added, would override existing element."):t[e[1]]=t.config[e[0]].bind(t))})},
...
;t.unhandlers=Object.entries(t.unhandlers).reduce(function(n,o){return o[0]===e?Hok.events.off(t.node,o[0],o[1]):n[o[0]]=o[1],n},{})},Knot.prototype.initTag=function(){this.tag=this.config.tag||"div",
this.node=this.config.ns?document.createElementNS(this.config.ns,this.tag):document.createElement(this.tag)},Knot.prototype.setEnd=function(e){const t=this
;return!this.rendered&&"end"in this.config&&typeof this.config.end===Hok.TYPES.F&&(this.ender=t.config.end.call(t)),this},Knot.prototype.render=function(){var e=this
;if(this.frag.appendChild(this.node),this.debt)for(var t=0,n=this.children.length;t<n;t++){var o=Object.assign({},e.children[t],{target:e.node,parentKnot:e,rootKnot:e.rootKnot});new Knot(o).render()
}else this.parentKnot&&this.parentKnot.solve(),this.initCheck.call(this).then(function(){e.clearTarget&&(e.target.innerHTML=""),e.cb.call(e).then(function(){e.aborted||e.target.appendChild(e.frag)
}).catch(function(){console.log("cant render: ",e)})}).catch(function(){e.frag.removeChild(e.node)});return this.rendered=!0,Promise.resolve(this)},Knot.prototype.clear=function(){
...
return e instanceof Knot},Knot.identifier="id",Knot.byIdIdentifier="kid";var __renders={},__nodes={};return{io:Hok.io,i18n:Hok.i18n,dom:Hok.dom,render:render,get:get,getKnotById:function(e){
return e in __nodes?__nodes[e]:null},getElement:function(e){return e in __renders&&__renders[e]},getElements:function(){return __renders}}}(window);"object"==typeof exports&&(module.exports=hokuto);