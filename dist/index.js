...
}function s(s,c,a,u){if(!o(c)&&!r(c))throw new Error("BAD PARAM: must search into an object or an array");var f,l=0,h=function(o,r){return e(o)&&n(r)?o.match(r):t(o,r)},d={key:function(t,e,n){
...
var i=[].concat.call(t,[e]),s=d(e,o[e],n),a=u.min<=r&&r<=u.max,f=i.length;a&&s&&(p.push({obj:o,value:o[e],key:i[f-1],parentKey:i[f-2],path:i.join("/"),getter:function(){return i.reduce(function(t,e){
...
t.appendChild(document.createTextNode(e))},t.setHtml=function(e,n){e.innerHTML=t.filterHtml(n)}}(Hok.dom),function(t){t.get=function(t,e,n){return fetch(t).then(function(t){return t.ok?t:(n(),
...
if(!t.ok)throw new Error("Network response was not ok");return t.text()}).then(function(t){return(new DOMParser).parseFromString(t,"text/xml")}).then(e).catch(n)}}(Hok.io),function(t){t._={events:{
...
unhandlers:{},bindErr:function(t){return"No straight way to "+(t?"":"un")+"}bind an event"}},t.saveUnhandler=function(e,n){t._.unhandlers[e]=t._.unhandlers[e]||[],t._.unhandlers[e].push(n)},
t.unhandle=function(e){t._.unhandlers[e]&&t._.unhandlers[e].forEach(function(t){t()}),t._.unhandlers=[]},t.on=function(){function e(e,n,o){t.saveUnhandler(e,function(){t.off(e,n,o)})}
...
if(null==t||"object"!=typeof t)return t;var e,n=t.constructor();for(e in t)t.hasOwn(e)&&(n[e]=_clone(t[e]));return n},_overwrite=function(t,e,n){
