...
noop:function(){},CONFIG:{},ns:{},dom:{},events:{},cookie:{},history:{},i18n:{},io:{},utils:{}};!function(t){"use strict";var e=function(){function t(t,e){
return JSON.stringify(t)===JSON.stringify(e)&&!n(e)}function e(t){return"string"==typeof t||t instanceof String}function n(t){return t instanceof RegExp}function o(t){
...
}function s(s,c,a,u){if(!o(c)&&!i(c))throw new Error("BAD PARAM: must search into an object or an array");var l,f=0,d=function(o,i){return e(o)&&n(i)?o.match(i):t(o,i)},h={key:function(t,e,n){
return"function"==typeof n?n(t):d(t,n)},value:function(t,e,n){return"function"==typeof n?n(e):d(e,n)},keyvalue:function(t,e,n){
return("function"==typeof n.key&&n.key(t)||d(t,n.key))&&("function"==typeof n.value&&n.value(e)||d(e,n.value))}}[s],p=[],m=function(t,e,n,o,i){
var r=[].concat.call(t,[e]),s=h(e,o[e],n),a=u.min<=i&&i<=u.max,l=r.length;a&&s&&(p.push({obj:o,value:o[e],key:r[l-1],parentKey:r[l-2],path:r.join("/"),getter:function(){return r.reduce(function(t,e){
return t[e]},c)},container:r.slice(0,l-1).join("/"),parentContainer:r.slice(0,l-2).join("/"),regexp:s,level:i}),f++),g(o[e],n,r,i+1)},g=function(t,e,n,o){if(!r(t)){var i,s
;if(t instanceof Array)for(i=0,s=t.length;i<s&&(m(n,i,e,t,o),u.limit!==f);i++);else if("object"==typeof t)for(i in t)if(m(n,i,e,t,o),u.limit===f)break}};return u.limit="limit"in u?~~u.limit:1/0,
...
var i=t.url,r=t.timeout||0,s=t.user||null,c=t.password||null,a=t.responseType,u=t.contentType,l=t.body||null,f=t.method,d=t.onCompleted||n,h=t.onLoad||n,p=t.onError||n,m=t.onAbort||n,g=t.onProgress||n,v=t.onLoadend||n,y=t.onLoadstart||n,k=t.onTimeout||n,b=t.headers||{},H=!!t.withCredentials,E=new XMLHttpRequest,T=!1
;E.responseType=a,E.withCredentials=H,E.timeout=r||null,E.addEventListener("load",h),E.addEventListener("progress",g),E.addEventListener("error",p),E.addEventListener("timeout",k),
...
e.FormData&&l instanceof e.FormData||(b=o(b,{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"})),l=new URLSearchParams(l)),E.open(f,i,!0,s,c);for(var N in b)E.setRequestHeader(N,b[N])
;return E.send(l),E};t.getJson=function(t){return i(o(t,{method:"GET",responseType:"json",contentType:"application/json"}))},t.getXML=function(t){return i(o(t,{method:"GET",responseType:"document",
...
t=t.replace(/^\//,"");var n=t.split(/\.|\//),o=n.length,i=0;if(e=typeof e!==Hok._U_?e:Hok.W,!t)return e;for(null;i<o;i+=1){if(typeof e[n[i]]===Hok._U_)return;e=e[n[i]]}return e},Hok.CONFIG={
AUTHOR:"Federico Ghedina",LANG:"en",ENGY:{STATS:!1,MODES:["PRE","LIVE"],MODE:0,COMPONENTS:{EXT:".js",URL:"/components/",NAME_PREPEND:"",PATH_SEPARATOR:"/"}},NS:"hokuto",NAME:"hokuto",VERSION:"0.0.19"
},Hok.cookie={enabled:!0,cookie_nocookiesaround:!1,initCheck:function(){return Hok.W.navigator.cookieEnabled},set:function(t,e,n,o,i,r){if(!Hok.cookie.enabled)return!1
...
var e=Hok.WD.cookie.split(";"),n=e.length,o="",i="",r=!1,s=0;if(!Hok.cookie.enabled)return!1;for(null;s<n;s+=1){if(o=e[s].split("="),o[0].replace(/^\s+|\s+$/g,"")===t)return r=!0,
o.length>1&&(i=Hok.W.unescape(o[1].replace(/^\s+|\s+$/g,""))),i;o=null,""}return r},delall:function(){if(!Hok.cookie.enabled)return!1;var t,e=Hok.WD.cookie.split(/;/),n=e.length,o=0
...
t.filterHtml=function(t){return""+t},t.setText=function(t,e){t.appendChild(document.createTextNode(e))},t.setHtml=function(e,n){e.innerHTML=t.filterHtml(n)},t.script=function(e,n){
var o=document.createElement("script"),i=e&&e.attrs;return i&&t.setAttrs(o,i),n&&(o.onload=function(){o.parentNode.removeChild(o)}),e.content?o.innerHTML=e.content:e.src&&o.setAttribute("src",e.src),o
},t.style=function(e){var n=e.content?{tag:"style",attrs:{}}:{tag:"link",attrs:{rel:"stylesheet",href:e.href}},o=document.createElement(n.tag),i=Object.assign(n.attrs,e&&e.attrs||{})
;return t.setAttrs(o,i),e.content&&(o.innerHTML=e.content),o},t.head=document.getElementsByTagName("head")[0]}(Hok.dom),function(t){t._={unhandlers:{},bindErr:function(t){
...
return"addEventListener"in Hok.W?function(t,n,o,i){i=i||!1,t.addEventListener.apply(t,[n,o,i]),e(t,n,o)}:"attachEvent"in Hok.W?function(t,n,o){t.attachEvent.apply(t,["on"+n,o]),e(t,n,o)}:function(){
...
"stopPropagation"in t&&t.stopPropagation(),t.preventDefault(),!1},t.once=function(e,n,o){t.on(e,n,function i(r){o.call(e,r),t.off(e,n,i)})},t.eventTarget=function(t){t=t||Hok.W.event
...
r&&window.clearTimeout(r),r=window.setTimeout(function(){n(t)},o)}o=o||3e3,n=n||function(){};var r;t.on(e,"mousemove",i),t.on(e,"click",i),t.on(e,"touchstart",i)},t.ready=function(){
...
t.load=function(t){e=t},t.parse=function(t){var e,o,i,r=Hok.searchHash.forValue(t,n),s=r.length,c=0;for(null;c<s;c++)i=r[c],
